...
def parse_shapenet_args():
    ...
    parser.add_argument('--start_num', default=32, type=int, help='start number of feature channels')
    # loss
    ...
    parser.add_argument('--K_coe', default=1.0, type=float, help='coefficient for gradient penalty')
    # test
    ...
    parser.add_argument('--dist_coe', default=1e-4, type=float, help='distance coefficient for density metric')
    parser.add_argument('--omega_xyzs', default=0.05, type=float, help='xyzs threshold used for f1 score calculation')
    parser.add_argument('--omega_normals', default=0.2, type=float, help='normals threshold used for f1 score calculation')
