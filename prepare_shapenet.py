...
def get_instance_dir(data_root, instance_num):
    ...
    for dir in data_dir:
        ...
        for ins_path in full_instance_name:
            #print('ins_path=',ins_path)
            ins_path_son = os.path.join(dir, ins_path, 'images')
            if not os.path.exists(ins_path_son) or not os.path.getsize(ins_path_son):
                full_instance_name.remove(ins_path)
...
def parse_dataset_args():
    ...
    # data root
    parser.add_argument('--data_root', default='/data/shapenet/', type=str, help='dir of shapenet core dataset')
...
if __name__ == '__main__':
    ...
    print('**convert_to_mesh have done!')
    ...
    print('**sample_pcd_from_mesh have done!')
