...
from models.loss import get_chamfer_loss,  get_normal_loss, get_latent_xyzs_loss
...
class AutoEncoder(nn.Module):
    ...
    def get_cd_loss(self, gt_xyzs, pred_xyzs):
        ...
        return chamfer_loss, loss_items, all_pred2gt_idx
    ...
    def forward(self, input):
        ...
        # get loss
        loss, loss_items, all_pred2gt_idx = self.get_cd_loss(gt_xyzs, pred_xyzs)
